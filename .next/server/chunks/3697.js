...
var dist_mimeTypes = mimeTypesInternal;
// index.ts
...
function populateMaps(extensions2, types2) {
    ...
    Object.keys(dist_mimeTypes).forEach((type)=>{
        ...
        for(let i = 0; i < exts.length; i++){
            ...
            if (types2[extension]) {
                const from = preference.indexOf(dist_mimeTypes[types2[extension]].source);
...
var db_mimeTypes = db_mimeTypesInternal;
...
var MimeTypeZod = zodEnumFromObjKeys(db_mimeTypes);
...
;// CONCATENATED MODULE: ./node_modules/uploadthing/dist/chunk-JJ6MOFV6.mjs
...
var buildRequestHandler = (opts)=>{
    return async (input)=>{
        ...
        try {
            ...
            if (limitHit) return new dist_UploadThingError({
                code: "BAD_REQUEST",
...
var buildPermissionsInfoHandler = (opts)=>{
 ...
 //# sourceMappingURL=chunk-JJ6MOFV6.mjs.map

;// CONCATENATED MODULE: ./node_modules/uploadthing/dist/chunk-EGTGNUUO.mjs
...
var createUploadthing = (opts)=>createBuilder(opts);
 //# sourceMappingURL=chunk-EGTGNUUO.mjs.map
